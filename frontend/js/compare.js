  ...
  "recraft-v3": {
    name: "Recraft V3",
    type: "Text-to-Image",
    description: "Recraft V3 is a next-gen text-to-image model that excels in generating visually stunning and conceptually accurate images from text prompts. It is designed with features to create vector art, ensuring smooth scalability for various applications. With an emphasis on brand consistency, Recraft V3 allows creators to generate images that align closely with brand guidelines and visual identity.",
  ...
  "sana-v1.5-4.8b": {
    name: "Sana V1.5 (4.8B)",
    type: "Text-to-Image",
    description: "Sana V1.5 is a 4.8B parameter text-to-image model focused on ultra-high detail rendering. It creates vivid, cinematic 4K visuals with precise features and depth. Perfect for design, fantasy art, and premium content generation, Sana offers excellent clarity and style in every result with fast generation time.",
  ...
  "lightricks-ltx-video": {
    name: "Lightricks LTX",
    type: "Text-to-Video",
    description: "Lightricks LTX is a sophisticated text-to-video model capable of generating 24 frames per second (FPS) video clips at 768x512 resolution. Using advanced DiT (Dual-Transformer) architecture, it excels at producing realistic videos with diverse scene transitions. It's particularly suited for creating dynamic, motion-based content that requires high-quality visuals with minimal computational overhead.",
  ...
  "luma-ray2-flash": {
    ...
    type: "Text-to-Video",
    description: "Luma Dream Machine: Ray 2 Flash is a dreamlike text-to-video generator that creates high-quality videos from text and image-based prompts. Its ability to transform textual input into beautiful cinematic scenes makes it perfect for filmmakers and artists. The model excels at generating ethereal, surreal scenes with soft color palettes, enhancing the creativity of the video production process.",
  ...
  "cogvideox-5b": {
    name: "CogVideoX-5B",
    type: "Text-to-Video",
    description: "CogVideoX-5B is a high-performance video synthesis model capable of generating vivid, coherent videos directly from text prompts. Known for its detailed visuals and fluid motion, it is well-suited for animation, storytelling, and conceptual video generation across a wide range of themes and scenes.",
  ...
  "kling-video-v2-master": {
    ...
    type: "Text-to-Video",
    description: "Kling 2.0 Master is a next-gen video model that delivers cinematic-quality video clips with remarkable speed and fluidity. Its fast processing and scene coherence make it ideal for creative short-form content, advertisements, and AI-driven storytelling with stunning visual impact.",
  ...
  "magi": {
    name: "MAGI-1",
    type: "Text-to-Video",
    description: "MAGI-1 is a powerful model for generating videos with complex physical interactions and cinematic camera angles. It excels in understanding prompt intent, creating realistic scenes with high temporal coherence, making it suitable for technical demos, storytelling, and science-based animations.",
  ...
  "vidu-q1": {
    name: "Vidu Q1",
    type: "Text-to-Video",
    description: "Vidu Q1 is optimized for producing visually rich 1080p videos with high motion fidelity and prompt accuracy. Its refined rendering pipeline enables dynamic scenes and varied expressions, making it ideal for social media, virtual prototyping, and animated creative work.",
  ...
  "veo2": {
    name: "Veo 2",
    type: "Text-to-Video",
    description: "Veo 2 is designed to deliver realistic video output with excellent camera control and visual finesse. It supports a wide variety of styles and motion types, making it ideal for cinematic experimentation, storyboarding, and creative film concepts driven by custom user prompts.",
...
"stackadoc-stable-audio": {
  ...
  "cassattemusic-audio": {
    ...
    type: "Text-to-Audio",
    description: "CassetteAI Music is a fast and versatile text-to-audio model that generates professional-quality music in seconds. It can produce high-fidelity music for a wide range of applications, from advertisements to film scores, all within moments of receiving a text prompt. The model is capable of generating full tracks in various genres and moods, offering creative flexibility for musicians and producers.",
  ...
  "multilingual-audio": {
    ...
    type: "Text-to-Audio",
    description: "ElevenLabs Multilingual TTS is a cutting-edge text-to-speech model that can synthesize voices in multiple languages. It offers high-quality voice synthesis for a variety of applications, including voiceovers, audiobooks, and accessibility services. With its realistic and dynamic voice generation, the model provides a seamless experience for content creators and businesses operating in global markets.",
  ...
  "american-audio": {
    ...
    type: "Text-to-Audio",
    description: "American English TTS is a high-quality text-to-speech model that specializes in American English voice synthesis. It produces natural-sounding voices with excellent clarity, making it ideal for creating voiceovers for videos, podcasts, and e-learning content. This model ensures high-quality output with minimal latency, providing a smooth voice synthesis experience for content creators and professionals.",
  ...
  "cassetteai-sfx-generator": {
    ...
    type: "Text-to-Audio",
    description: "Cassette AI’s Sound Effects Generator is an open-source model built to create ambient sounds and dynamic SFX from prompt input. From nature atmospheres to sci-fi transitions, this tool is ideal for indie games, films, and podcasts that need quick, creative sound design without manual recording.",
  ...
  "fal-ai-kokoro-hindi": {
    ...
    type: "Text-to-Audio",
    description: "Kokoro Hindi TTS is a fast, expressive text-to-speech model optimized for the Hindi language. It delivers clear pronunciation, natural intonation, and emotional tone shifts, making it ideal for voice assistants, educational content, and localized audio experiences in Hindi.",
    source: "https://huggingface.co/fal-ai/kokoro/hindi",
    price: 4,
    icons: ["bi-voice-over"],
    performance: {
      latency: "150ms",
  ...
  "fal-ai-mmaudio-v2-text-to-audio": {
    ...
    type: "Text-to-Audio",
    description: "MMAudio V2 is designed to generate realistic, context-aware audio scenes from detailed text prompts. It captures nuances like environment, timing, and emotion, making it suitable for media, simulation, and generative storytelling with dynamic, synchronized audio experiences.",
    source: "https://huggingface.co/fal-ai/mmaudio-v2/text-to-audio",
    price: 3,
    icons: ["bi-file-music"],
    performance: {
      latency: "280ms",
  ...
  type: "Text-to-Audio",
  description: "Multilingual TTS by ElevenLabs (via FAL AI) offers high-quality voice synthesis in multiple languages. It supports natural, expressive speech generation with a variety of voice profiles suitable for narration, accessibility, and content localization. Ideal for developers and creators working with global audiences.",
  source: "https://fal.ai/models/fal-ai/elevenlabs/tts/multilingual-v2",
  price: 4,
  icons: ["bi-translate"],
  performance: {
    ...
    container.innerHTML = `
        ...
        <div class="model-header">
            <h4>${model.name}</h4>
            <div>${model.icons.map(icon => `<i class="bi ${icon} me-1"></i>`).join("")}</div>
        </div>
        <p class="text-muted mb-1"><strong>Type:</strong> ${model.type}</p>
        <p>${model.description}</p>
        <p class="mb-1 model-price"><i class="bi bi-coin"></i> ${model.price} credits per request</p>
        <p class="text-muted"><strong>Source:</strong> <a href="${model.source}" target="_blank">${model.source}</a></p>
